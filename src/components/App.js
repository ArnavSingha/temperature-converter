        ...
        <div>
            ...
            <div className="ui raised very padded container segment" style={{ marginTop: "10px", width: "930px" }}>
                ...
                {/* <GitHubButton data-icon="octicon-star" data-size="large" data-show-count="true"
                    href="">Giving Star helps your brother :)
                </GitHubButton> */}
                ...
                <div className="ui message">
                    ...
                    <p>Please Enable Location Permission in your browser so that app gets your current geolocation's temperature.
                        Temperature converter which automatically converts between Celsius, Fahrenheit, Kelvin, Rankine and Reaumur.
                    </p>
                </div>
                ...
                <div className="ui bottom left attached label">Developer Arnav Singha <a
                    href="mailto:arnav.singha@gmail.com"> arnav.singha@gmail.com</a></div>
            </div>
